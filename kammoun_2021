...
LX=0.027#is the observed, 2−10 keV luminosity in units of 0.01 of the Eddington luminosity,
M= 2#M7 is the BH mass in units of 107M
lambda_ref=1928 # UVW2 REFERENCE BAND
lambda0=1950 # NORMALIZATION
spin =1

wave_inf =0 #lower limit of lag spectrum 
wave_up=10000 #upper limit of lag spectrum 
